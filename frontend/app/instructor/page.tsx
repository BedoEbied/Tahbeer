...
import { useStoredUser } from '@/lib/hooks/useStoredUser';

export default function InstructorDashboard() {
  const { isLoading } = useRequireAuth([UserRole.INSTRUCTOR, UserRole.ADMIN]);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center">
              <span className="text-gray-700 mr-4">{storedUser?.name ?? ''}</span>
              <Link
